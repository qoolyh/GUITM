...
from bind import get_bind_info
...
def GBTM(suffix):
    fileOBJ = open("data/" + cate + "/" + srcFolder + "_" + tarFolder + suffix+'.txt', 'w', encoding="utf-8")
    ...
    for src in srcGroup:
        ...
        for tar in tarGroup:
            ...
            if src != tar:
                ...
                src_bind = get_bind_info(src_dict)
                tgt_bind = get_bind_info(tar_dict)
                GBTM('_oracle_test')
    tmp = cate.split('_')
